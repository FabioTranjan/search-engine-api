        ...
        it 'searches the query text both on google and bing' do
          VCR.use_cassette('engine_searcher/request_google_and_bing_success') do
            ...
            expect(search.last).to eq ({
              :description=>"⚡ O Teste de Velocidade do Tecnoblog tem a tecnologia Speed Test da nPerf, o velocímetro é compatível com todas as conexões: cabo, satélite, Wi-Fi e 4G.",
              :engine=>"bing",
